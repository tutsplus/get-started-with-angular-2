    ...
    return {
        ...
        execute: function() {
            StudentDetailComponent = (function () {
                function StudentDetailComponent(_routeParams, _router, _studentService) {
                ...
                StudentDetailComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var studentID = this._routeParams.get('id');
                    this._studentService.getStudent(studentID).then(function (theStudent) { return _this.student = theStudent; });
                };
                StudentDetailComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.RouteParams, router_1.Router, student_service_1.StudentService])
